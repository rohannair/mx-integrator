defmodule MxIntegrator.Atrium do
  def api_key, do: Application.get_env(:mx_integrator, :api_key, "")

  def client_id, do: Application.get_env(:mx_integrator, :client_id, "")

  def base_url, do: Application.get_env(:mx_integrator, :base_url, "https://vestibule.mx.com")
